...
\begin{align*}
	S =& \begin{pmatrix}
		...
		0& \frac{\rho + \big[\frac{m_1}{\mu}\big]^2 r \cos(\theta-\Theta)}{r_{23}} & \frac{\rho + \big[\frac{m_2}{\mu}\big]^2 r \cos(\theta-\Theta)}{r_{13}}\\
		0& \frac{\big[\frac{m_1}{\mu}\big]^2 r \rho \sin(\theta-\Theta)}{r_{23}}& \frac{\big[\frac{m_2}{\mu}\big]^2 r \rho \sin(\theta-\Theta)}{r_{13}}
	\end{pmatrix}
\end{align*}
