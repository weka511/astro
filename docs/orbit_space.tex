...
\begin{align*}
	\vec{r_3} - \vec{r_2} =& \vec{\rho} - \frac{m_1}{\mu}\vec{r} \text{, whose RHS is identical to \eqref{eq:r_3:r_1} if we substitute $-m_1$ for $m_2$.}
\end{align*}
We will substitute \eqref{eq:r:13:d_r}, \eqref{eq:r:13:d_theta}, \eqref{eq:r:13:d_rho}, and \eqref{eq:r:13:d_Theta} in \eqref{eq:S:1} to give:
